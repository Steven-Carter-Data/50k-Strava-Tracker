...
#     # Insert "Points" column after "Zone 5" if it exists, otherwise append
#     if "Zone 5" in weekly_data.columns:
#         zone5_index = weekly_data.columns.get_loc("Zone 5")
#         # Check if 'Points' column already exists to avoid duplicate insertion error
#         if 'Points' in weekly_data.columns:
#              # If it exists, maybe drop it first or just ensure calculation is correct
#              points_col_data = weekly_data.pop('Points') # Remove existing before inserting
#         weekly_data.insert(zone5_index + 1, "Points", weekly_data["Points"]) # Re-insert calculated points
#     # else: # Points column already appended during calculation
